...
urlpatterns = [
    ...
    path('export/dashboard/commander/pptx/', views.ExportCommanderDashboardPPTXView.as_view(), name='export_commander_pptx'),
    path('export/dashboard/g-head/pptx/', views.ExportGHeadDashboardPPTXView.as_view(), name='export_g_head_pptx'),
    path('export/dashboard/department/<str:dept>/pptx/', views.ExportDepartmentDashboardPPTXView.as_view(), name='export_department_pptx'),
    path('export/dashboard/registration/pptx/', views.ExportRegistrationDashboardPPTXView.as_view(), name='export_registration_pptx'),
